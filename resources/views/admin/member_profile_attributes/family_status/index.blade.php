                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @can('edit_family_value')
                                        <a href="javascript:void(0);" onclick="family_status_modal('{{ route('family-status.edit', encrypt($family_status->id)) }}')" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">
