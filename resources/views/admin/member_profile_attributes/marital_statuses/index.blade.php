                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @can('edit_marital_status')
                                        <a href="javascript:void(0);" onclick="maritial_status_modal('{{ route('marital-statuses.edit', encrypt($marital_statuse->id)) }}')" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">
