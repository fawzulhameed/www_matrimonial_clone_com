                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                  @can('edit_member_language')
                                      <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="javascript:void(0);" onclick="language_modal('{{ route('member-languages.edit', encrypt($language->id) )}}')" title="{{ translate('Edit') }}">
