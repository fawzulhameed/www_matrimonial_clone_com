                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @can('edit_family_value')
                                        <a href="javascript:void(0);" onclick="family_value_modal('{{ route('family-values.edit', encrypt($family_value->id) )}}')" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">
