                  ...
                  <form action="{{ route('settings.update') }}" method="POST" >
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="number" name="member_min_age" step="1" class="form-control" value="{{ get_setting('member_min_age') }}">
                          </div>
                      </div>
              ...
              <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="updateSettings(this, 'wallet_system')" <?php if(\App\Models\Setting::where('type', 'wallet_system')->first()->value == 1) echo "checked";?>>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
