...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <div class="">
                <a href="{{ static_asset('download/member_bulk_demo.xlsx') }}" download><button class="btn btn-info">{{ translate('Download CSV')}}</button></a>
            </div>
            <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
            ...
            <br>
            <div class="">
                <a href="{{ route('pdf.on_behalf') }}"><button class="btn btn-info">{{translate('Download On Behalf')}}</button></a>
                <a href="{{ route('pdf.package') }}"><button class="btn btn-info">{{translate('Download Package')}}</button></a>
            </div>
            <br>
        </div>
    </div>
